...
<input class="in" type="password" name="newPassword" placeholder="Enter New Password" required>
<br>
</div>
<div class="left-div">
<h2>Confirm New Password</h2>
<input class="in" type="password" name="cNewPassword" placeholder="Confirm New Password" required>
<br>
</div>
<br>
